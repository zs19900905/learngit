...
class TestStolen(unittest.TestCase):
    def testStolenA001(self):
        dc = {}
        ...
        # 1、我被盗窃了
        sleep(2)
        stolen = driver.find_element_by_xpath("//android.widget.TextView[@text='1.我被盗窃了']").click()
        # 2、 阅读<行政案件义务告知书>
        sleep(1)
        ...
        # 6、输入名字
        ipt_name = driver.find_element_by_xpath("//android.widget.EditText[@index='0']").send_keys("A草莓")
        ...
        # 40、看到嫌疑人
        see_suspect = driver.find_element_by_xpath("//android.widget.TextView[@text='1.看到']").click()
        # 41、嫌疑人数量
