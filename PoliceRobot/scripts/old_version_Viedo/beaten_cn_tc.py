...
class TestBeaten(unittest.TestCase):
    def testBeatenA008(self):
        dc = {}
        ...
        # 2、我被人殴打
        beatened = driver.find_element_by_xpath("//android.widget.TextView[@text='2.我被人殴打了']").click()
        sleep(1)
        # 3、 阅读<被害人诉讼权利义务告知书>
        ...
        # 6、输入名字
        ipt_name = driver.find_element_by_xpath("//android.widget.EditText[@index='0']").send_keys("H西瓜")
        ...
        confirm_button = driver.find_element_by_xpath("//android.widget.Button[@text='确认']").click()
        #21、请问对方如何殴打你
        beaten_way = driver.find_element_by_xpath("//android.widget.EditText[@text='例如：拳打、脚踢、扇巴掌等方式']").send_keys("拳打")
        confirm_button = driver.find_element_by_xpath("//android.widget.Button[@text='确认']").click()
        #22、在抢劫过程中有使用工具
