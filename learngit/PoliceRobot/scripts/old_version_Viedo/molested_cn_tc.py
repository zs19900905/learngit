...
class TestMolested(unittest.TestCase):
    def testMolestedA010(self):
        dc = {}
        ...
        # 2、我被猥亵了
        beatened = driver.find_element_by_xpath("//android.widget.TextView[@text='2.我被猥亵了']").click()
        # 3、 阅读<被害人诉讼权利义务告知书>
        ...
        # 6、输入名字
        ipt_name = driver.find_element_by_xpath("//android.widget.EditText[@index='0']").send_keys("J葡萄")
        ...
        confirm_button = driver.find_element_by_xpath("//android.widget.Button[@text='确认']").click()
        #21、请问嫌疑人的猥亵方式
        molest_way = driver.find_element_by_xpath("//android.widget.TextView[@text='4.散发淫秽书刊图片']").click()
        # 22、请问淫秽物品的具体内容
        details = driver.find_element_by_xpath("//android.widget.TextView[@text='1.性交场面']").click()
        #23、请问淫秽物品数量
        amount = driver.find_element_by_xpath("//android.widget.EditText[@text=' 例如：XX本XX张']").send_keys("三本共30页")
        confirm_button = driver.find_element_by_xpath("//android.widget.Button[@text='确认']").click()
        # 24、请问如何派发
        distributed_way = driver.find_element_by_xpath("//android.widget.EditText[@index='0']").send_keys("雇人路边发")
        confirm_button = driver.find_element_by_xpath("//android.widget.Button[@text='确认']").click()
        # 25、请问淫秽物品现在何处
        things_place = driver.find_element_by_xpath("//android.widget.TextView[@text='1.在现场']").click()
